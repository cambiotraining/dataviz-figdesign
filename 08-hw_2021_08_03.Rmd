...
1. Colour the scatter plot points in red and add in a smooth trend line. <details><summary>Hint</summary>Use `geom_smooth()` to add a trend line to the data.</details>
1. Colour the points by the variable "world_region" instead.
1. Assign the scatter plot (with the trendline) to an appropriately named object. 
