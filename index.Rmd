---
title: "Widening Participation Summer School Bioinformatics Training Sessions"
toc: hide
---
...
4. [Data visualisation](03-data_visualisation.html)
5. [Data manipulation](04-data_manipulation.html)
...
All the software required to run this course can be installed on your own machine. We also have additional laptops available for use during the course. Alternatively, if installation proves to be difficult, we can also provide you with access to a web-based virtual learning environment. Please contact Matt for further information.
